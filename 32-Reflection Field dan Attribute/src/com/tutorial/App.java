...
public class App {
    public static void main(String[] args) throws IllegalArgumentException, IllegalAccessException {
		...
		hero1.showall(); // bisa dilakukan
		// hero1.heroType = "intel"; tidak bisa lakukan
		// hero1.name = "ucup"; tidak bisa dilakukan

		// Reflection
		Class<?> classHero1 = hero1.getClass();
		Class<?> parentClassHero1 = hero1.getClass().getSuperclass(); //to get the information about sub n superclass
		...
		Field[] hero1Fields = classHero1.getFields(); //berupa array
		...
		Field[] hero1AllFields = classHero1.getDeclaredFields(); //jumlah atribut
